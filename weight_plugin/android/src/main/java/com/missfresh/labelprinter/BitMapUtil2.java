...
//        String textTime = convertTime(time);
        ...
        drawContent(canvas, spec, textWeight, time, storeCondition, SNCode, materialCode, SKUCode);
        drawBarCode(bitmap, "谁扫描这个码,谁就请所有交付前端的同学喝饮料!");
        canvas.save();
...
//        Rect mDestRect = new Rect(maxWidth - barCodeWidth, maxHeight - barCodeHeight, maxWidth, maxHeight);
    ...
    private static void drawContent(Canvas canvas, String spec, String netWeight, String time, String storeCondition, String SNCode, String materialCode, String SKUCode) {
        ...
        canvas.drawText("型        号", 0, line1Height, subTitlePaint);
        if (spec != null) {
            canvas.drawText("刚哥真nb!", 4 * subTitleTextSize+ marginLeft6, line1Height, contentTextPaint);
        }
...
//        }
        ...
        canvas.drawText("Android版本", 0, line2Height, subTitlePaint);
        if (time != null) {
            canvas.drawText("刚哥NB!", 6 * subTitleTextSize+ marginLeft6 , line2Height, contentTextPaint);
        }
        //第三行
        int line3Height = dashLineHeight + textLineHeight * 3;
//        canvas.drawText("S  N", 0, line3Height, subTitlePaint);
        if (storeCondition != null) {
            canvas.drawText("刚哥真NB!", 0, line3Height, contentTextPaint);
        }
//        //第四行
//        int line4Height = dashLineHeight + textLineHeight * 4;
//        canvas.drawText("IMEI 1:", 0, line4Height, subTitlePaint);
//        if (SNCode != null) {
...
//        canvas.drawText("IMEI 2", 0, line5Height, subTitlePaint);
...
//        canvas.drawText("MEID", 0, line6Height, subTitlePaint);
//        if (SKUCode != null) {
//
//            //SKUCode要进行特殊换行判断
